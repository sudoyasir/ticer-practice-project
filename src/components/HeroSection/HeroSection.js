import '../HeroSection/HeroSection-style.css'
...
export default function HeroSection(){
    ...
    <div className="container hero_section">
        ...
        <button className="btn btn-primary py-2 fw-bold primary_btn mt-4">L E A R N&nbsp;&nbsp;N O W&nbsp;&nbsp;&nbsp;&nbsp;<i className="fa fa-angle-right" style={{fontSize:'20px'}}></i></button>
        </div>
    </div>
